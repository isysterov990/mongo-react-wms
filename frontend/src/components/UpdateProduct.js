...
const UpdateProductForm = ({openUpdate, handleClose}) => {
    ...
    const updateProduct = async (data) => {
        console.log("hello")
        const url = `${BASE_URL}/products/${data.product_id}?name=${data.name}&price=${data.price}&description=${data.description}&category=${data.category}&quantity=${data.quantity}&supplier_id=${data.supplier_id}&supplier_name=${data.supplier_name}&supplier_email=${data.supplier_email}&supplier_phone=${data.supplier_phone}`;
        try {
