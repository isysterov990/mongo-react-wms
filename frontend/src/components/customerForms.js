...
const ProductButtons = () => {
    ...
    return (
        <div>
            ...
            <AddProductForm openAdd={openAdd} handleClose={handleClose}/>
            <UpdateProductForm openUpdate={openUpdate} handleClose={handleClose}/>
            <DeleteProductForm openDelete={openDelete} handleClose={handleClose}/>
        </div>
    );
}
