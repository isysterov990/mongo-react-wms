...
# Customer Endpoints
@app.post("/customers")
async def create_customer(customer_id: int, name: str, email: str, phone: str, address: str, city: str, province: str,
...
async def update_customer(customer_id: int, name: Optional[str] = None, email: Optional[str] = None,
...
# Product Endpoints
@app.post("/products")
async def create_product(product_id: int, name: str, price: float, description: str, category: str, quantity: int,
                         supplier_id: int, supplier_name: str, supplier_email: str, supplier_phone: str):
    result = product.insertProduct(product_id, name, price, description, category, quantity, supplier_id, supplier_name,
...
async def update_product(product_id: int, name: Optional[str] = None, price: Optional[float] = None,
                         description: Optional[str] = None, category: Optional[str] = None,
                         quantity: Optional[int] = None, supplier_id: Optional[int] = None,
                         supplier_name: Optional[str] = None, supplier_email: Optional[str] = None,
                         supplier_phone: Optional[str] = None):
    result = product.updateProduct(product_id, name, price, description, category, quantity, supplier_id, supplier_name,
                                   supplier_email, supplier_phone)
    return {"message": result}
...
# Order Endpoints
@app.post("/orders")
async def create_order(order_id: int, order_date: str, customer_id: int, customer_name: str, customer_email: str,
                       customer_phone: str, shipping_address: dict, products: list):
    result = order.insertOrder(order_id, order_date, customer_id, customer_name, customer_email, customer_phone,
...
async def update_order(order_id: int, order_date: Optional[str] = None, customer_id: Optional[int] = None,
                       customer_name: Optional[str] = None, customer_email: Optional[str] = None,
                       customer_phone: Optional[str] = None, shipping_address: Optional[dict] = None,
                       products: Optional[list] = None):
    result = order.updateOrder(order_id, order_date, customer_id, customer_name, customer_email, customer_phone,
                               shipping_address, products)
    return {"message": result}
...
async def update_supplier(supplier_id: int, name: Optional[str] = None, email: Optional[str] = None,
                          phone: Optional[str] = None, products: Optional[List[dict]] = None):
